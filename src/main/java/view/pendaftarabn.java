 ...
 * @author USER
 */
public class pendaftarabn extends javax.swing.JFrame {

    /**
     * Creates new form pendaftarabn
     */
    public pendaftarabn() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
        // 1. Mengambil data dari inputan form sesuai urutan field yang benar
        String nama = jTextField1.getText();        // jTextField1 adalah Nama
        String biayaStr = jTextField2.getText();    // jTextField2 adalah Biaya Kursus
        String jumlahStr = jTextField3.getText();   // jTextField3 adalah Jumlah
        ...
        // Pesan error jika biaya atau jumlah kosong / bukan angka murni
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pendaftarabn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pendaftarabn().setVisible(true);
            }
        });
    }
